...
For a full description of the module, visit us on github:
  https://github.com/WDGDC/jarvis-drupal

To submit bug reports and feature suggestions, or to track changes:
  https://github.com/WDGDC/jarvis-drupal/issues/new
...
* To add menus available to Jarvis, use hook_jarvis_menus_alter().

* To add menu items available to Jarvis, use hook_jarvis_menu_items_alter().


-- CONTACT --

Authors:
* Doug Axelrod - https://www.drupal.org/u/daxelrod
* David Everett
* Kurtis Shaner
* Grant Skalak - https://www.drupal.org/u/gskalak

This project has been sponsored by:
* The Web Development Group - https://www.drupal.org/u/wdgdc
  Read more at http://www.webdevelopmentgroup.com